    ...
    <div className="flex flex-wrap mb-4 overflow-auto content-center justify-center">
      <div className="w-full rounded overflow-hidden bg-white shadow-lg">
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-grey-darker text-base">{props.article.contenu}</p>
        </div>
        <div className="px-6 py-4">
          <span
            className="inline-block bg-grey-lighter rounded-full
           px-3 py-1 text-sm font-semibold text-grey-darker mr-2"
          >
